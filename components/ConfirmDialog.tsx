...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
      ...
      {/* Dialog */}
      <div role="alertdialog" aria-modal="true" className="bg-white dark:bg-stone-900 w-full max-w-sm p-8 rounded-[2.5rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] relative z-10 animate-scale-in border border-stone-100 dark:border-stone-800 transform transition-all">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={onConfirm} 
            disabled={isConfirming}
            className="flex-1 py-4 rounded-2xl bg-red-500 text-white font-black uppercase text-[10px] tracking-widest hover:bg-red-600 transition-all shadow-xl shadow-red-500/20 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
          >
